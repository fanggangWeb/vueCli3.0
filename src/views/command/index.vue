  ...
  <div class="container3">
    <div class="top-bread">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item class="text">指挥调度</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
      ...
      <el-table :data="dataList" style="width: 100%">
        ...
        <el-table-column fixed="right" label="操作" align="center" width="120">
          <template slot-scope="scope">
            <el-button type="primary" size="small" plain @click="command(scope.row)">指挥</el-button>
...
<script>
  export default {
    ...
    methods: {
      ...
      del(item) {},
      command(item) {
        this.$router.push({path: '/home/emergency/commandCenter'})
      },
      handle (item) {
