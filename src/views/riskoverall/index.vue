  ...
  <div class="container3">
    <div class="top-bread">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item class="text">桥梁总体风险评估</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="action-bar">
      ...
      <div class="bar-bottom">
        ...
        <div class="system-btn history-btn big-space" @click="historyDel">
          <div class="icon"></div>
          <div class="text">历史删除</div>
        </div>
      </div>
    </div>
      ...
      <el-table :data="dataList" style="width: 100%">
        ...
        <el-table-column prop="date" align="center" label="风险统计表" width="240">
          <template slot-scope="scope">
            <el-button size="small" plain @click="lock(scope.row)">查看</el-button>
            <el-button size="small" plain>评估</el-button>
            <el-button size="small" plain>导出</el-button>
          </template>
        </el-table-column>
        <el-table-column fixed="right" label="操作" align="center" width="180">
          <template slot-scope="scope">
            <el-button type="primary" size="small" plain @click="firstJudge(scope.row)">修改</el-button>
